...
public class DriveSubsystem extends SwerveDrivetrain {

    private static SwerveDrivetrainConfig config = SwerveDrivetrainConfig.builder()
    ...
    private static SwerveModuleConfigBuilder<?,?> baseModuleConfig() {
